...
if __name__ == '__main__':
    ...
    def test():
        ...
        try:
            ns.get_nested(
                ("A", "A_C", 0, "A_C_A", "something not here", "something else not here"))
        except AttributeError:
            assert True
        else:
            assert False
        ...
        try:
            modify_ns.set_nested(
                ("D", "D_A", "D_A_A", "D_A_A_A", "D_A_A_A_A"), "E")
            assert False
        except AttributeError:
            assert True
        modify_ns.set_nested(
            ("D", "D_A", "D_A_A", "D_A_A_A", "D_A_A_A_A"), "E", create=True)
        assert modify_ns.get_nested(
            ("D", "D_A", "D_A_A", "D_A_A_A", "D_A_A_A_A")) == "E"
